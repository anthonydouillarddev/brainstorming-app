...
import type { FlowsMode } from "../state";

const MODES: { key: FlowsMode; label: string; emoji: string; hint: string }[] = [
  {
    key: "beginner",
    label: "Débutant",
    emoji: "🐣",
    hint: "Chat guidé · le parcours en 5 étapes",
  },
  {
    key: "intermediate",
    label: "Formulaire",
