...
export const DESIGN_CHAPTERS: DesignChapter[] = [
  ...
  { key: "states", num: 8, emoji: "⚡", label: "États", hint: "Loading, empty, error, success, toasts, machines, SLO", status: "ready" },
  { key: "microcopy", num: 9, emoji: "✍️", label: "Microcopy", hint: "CTAs, champs, system, glossaire, voice & tone, variants, budgets, inclusion", status: "ready" },
  { key: "a11y", num: 10, emoji: "♿", label: "Accessibilité", hint: "WCAG 2.2 AA, clavier, ARIA, AT, cognitif, motion, roadmap", status: "ready" },
  { key: "adaptivity", num: 11, emoji: "📱", label: "Adaptativité", hint: "Breakpoints, dark mode, densité, input modality", status: "ready" },
  { key: "validation", num: 12, emoji: "🧪", label: "Validation", hint: "Tests users, SUS, heuristiques Nielsen, PMF", status: "ready" },
];
