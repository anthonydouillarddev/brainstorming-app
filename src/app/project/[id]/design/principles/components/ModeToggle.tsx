...
import type { PrinciplesMode } from "../state";

const MODES: { key: PrinciplesMode; label: string; emoji: string; hint: string }[] = [
  {
    key: "beginner",
    label: "Débutant",
    emoji: "🐣",
    hint: "Chat guidé · 10 heuristiques Nielsen une par une",
  },
  {
    key: "intermediate",
    label: "Formulaire",
...
export default function ModeToggle({
  ...
  mode: PrinciplesMode;
  onChange: (mode: PrinciplesMode) => void;
}) {
  return (
