...
import type { StatesMode } from "../state";

const MODES: { key: StatesMode; label: string; emoji: string; hint: string }[] = [
  {
    key: "beginner",
    label: "Débutant",
    emoji: "🐣",
    hint: "Chat guidé · pattern par pattern",
  },
  {
    key: "intermediate",
    label: "Formulaire",
