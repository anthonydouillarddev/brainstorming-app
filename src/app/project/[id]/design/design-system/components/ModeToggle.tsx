...
import type { DesignSystemMode } from "../state";

const MODES: { key: DesignSystemMode; label: string; emoji: string; hint: string }[] = [
  {
    key: "beginner",
    label: "Débutant",
    emoji: "🐣",
    hint: "Chat guidé · coche les composants dont tu as besoin",
  },
  {
    key: "intermediate",
    label: "Formulaire",
...
export default function ModeToggle({
  ...
  onChange: (mode: DesignSystemMode) => void;
}) {
  return (
