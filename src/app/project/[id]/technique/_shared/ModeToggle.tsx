...
// Mode toggle générique — tous les chapitres Technique utilisent "beginner" | "intermediate".
export type ChapterMode = "beginner" | "intermediate";
